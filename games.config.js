...
export const GAMES = [
  ...
  },
  {
    ...
    emoji:       '�',
    accentColor: '#ef4444',
    description: 'Flip tiles and find matching pairs of country flags & Avenger heroes!<br>1 Player vs Computer or 2 Players vs each other.',
    href:        './mahjong/index.html',
    controls:    'Click any face-down tile to flip it',
  },
  {
    id:          'american-mahjong',
    ...
    emoji:       '🀄',
    accentColor: '#f59e0b',
    description: 'Push tiles through your 4×9 grid — chain your suit, pass the opponent\'s!<br>Spin the wheel to decide who takes the Dragon first.',
    href:        './american-mahjong/index.html',
    controls:    'Click a column to push your tile · Dragon = wild',
  },
  {
    id:          'galaxy-shooter',
    name:        'Galaxy Shooter',
    emoji:       '🚀',
    accentColor: '#818cf8',
    description: 'Defend the galaxy from alien invaders!<br>Clear waves to advance levels — bosses lurk every 3 levels.',
    href:        './galaxy-shooter/index.html',
